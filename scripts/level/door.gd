...
## AnimatableBody2D на слое 6 (Layers.SHADOW_PASSABLE): держит игрока и врагов, закрывает
## обзор врагам, останавливает пули и свет, но ТЕНЬ проходит сквозь неё.
## Двигается твином, физика синхронизирована.
